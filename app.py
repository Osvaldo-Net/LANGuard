...
def escanear_red():
    try:
        ...
        dispositivos_arp = []
        try:
            red_local = ipaddress.IPv4Network(obtener_red_local(),
                                              strict=False)
            salida_arp = subprocess.check_output(["ip", "neigh", "show"],
                                                 timeout=5).decode()
        	...
        	continue
                ...
                if match:
                    ...
                    dispositivos_arp.append({
                        ...
                        fabricante_arp,
                        "confiable":
                        mac_arp in macs_confiables,
                        "nombre":
                        NOMBRES_DISPOSITIVOS.get(mac_arp)
                    })
